...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 shadow-lg hover:text-neutral-700 dark:bg-neutral-600 z-10 w-full py-3 px-2 flex justify-between items-center navbar">
      ...
      <div className="list-none  sm:flex hidden justify-between items-center flex-1">
        <ul className="text-base flex justify-between px-2">
          <li className="px-6 py-2 font-bold text-white leading-5 hover:text-blue-300">
        ...
        <ul className="flex items-center w-auto pl-10 py-5">
          <li className="px-5 py-2 font-bold text-white leading-5 hover:text-blue-500">
